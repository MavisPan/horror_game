...
t = font2.render("Переключение диалога: f", True, (0, 0, 0))
...
t5 = font1.render("Стоп... А что это за книга?", True, (0,0,0), (255,255,255))
t51 = font1.render("И где моя булочка?!", True, (0,0,0), (255,255,255))
...
satania = GameSprite('pngwing.com (1).png', 100, 400, 2,200,400)
satania2 = GameSprite('pngwing.com (2).png', 100, 300, 2, 300,400)
satania3 = GameSprite('pngwing.com (3).png', 200, 400, 2,200,400)
satania4 = GameSprite('sat.png', 200, 400, 2,200,400)
toradora = GameSprite('tora.png', 100, 200, 2,500,600)
bun = GameSprite('bun.png', 500, 400, 2, 100, 100)
speed_x = 3
speed_y = 3
num = 1
gameStage = 0
loose = font1.render('WASTED', True, (255,0,0))
win = font1.render('Сатания съела булочку!', True, (221, 127, 255))
